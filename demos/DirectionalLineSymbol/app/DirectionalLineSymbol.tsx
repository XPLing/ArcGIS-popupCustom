...
class DirectionalLineSymbol extends Widget {
  ...
  render(): VNode {
    ...
    return (
      <div class={this.classes(CSS.root, baseClasses)}
  ...
  protected renderPopupHeader = () => {
    return (
      <div class={this.classes(CSS.header)}
        ...
        <div class={this.classes(CSS.buttons)}>
          {
            this.closeButton ?
              <div class={this.classes(CSS.button)} title={this.closeTip} onclick={this._handleClose} bind={this}>
